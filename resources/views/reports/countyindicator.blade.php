...
@section('content')
    ...
    <script language = "javascript" type = "text/javascript">
        ...
        function ajaxFunction(){
            ...
            ajaxRequest.open("GET", "<?php echo url('/'); ?>/reports/getindicators" + queryString, true);
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::open(array('route' => 'reports.countyreport','method'=>'POST')) !!}
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        ...
                                        <select name="rollingplan_id" id="rollingplan_id" class="form-control" required="required">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        ...
                                        <select name="indicatorcategory_id" id="indicatorcategory_id" class="form-control" onChange="ajaxFunction()" required="required">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                        ...
                                        <div id = 'ajaxDiv'>
                                        <select name="mesindicator_id" class="form-control" required="required">
